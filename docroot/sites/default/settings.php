...
if (extension_loaded('newrelic')) {
  ...
  newrelic_set_appname("$site_domain;pharm", '', 'true');
}
// Acquia specific settings.
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/' . $_ENV['AH_SITE_GROUP'] . '/collegeofpharmacy-settings.inc';
  if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
    $settings['file_temp_path'] = "/shared/tmp";
    $settings['file_private_path'] = "/shared/sites/default/files-private";
  }
